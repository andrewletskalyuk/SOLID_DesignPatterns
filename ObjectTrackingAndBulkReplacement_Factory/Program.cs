...
namespace ObjectTrackingAndBulkReplacement_Factory
{

    /// <summary>
    /// Bulk replacement - масова заміна
    /// </summary>
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //змінюємо тему через завод - от це мазефака магія

            factory2.ReplaceTheme(false); //і тепер це світла тема)))
            WriteLine(magicTheme.Value.BgrColor);
